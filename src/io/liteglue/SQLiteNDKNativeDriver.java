/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Mon Mar 22 00:04:21 EDT 2021 ----! */
...
public class SQLiteNDKNativeDriver {
  ...
  public static native SQLiteNativeResponse sqlc_db_open(String filename, int flags);

  /** Interface to C language function: <br> <code> sqlc_handle_t sqlc_db_prepare_st(sqlc_handle_t db, const char *  sql); </code>    */
  public static native SQLiteNativeResponse sqlc_db_prepare_st(long db, String sql);
...
} // end of class SQLiteNDKNativeDriver
